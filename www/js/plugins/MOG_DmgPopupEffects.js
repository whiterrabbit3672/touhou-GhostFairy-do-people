 ...
 * 为伤害精灵添加一些效果和新的字符串
 *
 * 图像的高度需要分为8份，以使图像对齐。（默认是5份）
   
   素材名称：Damage.png
 *
 * =============================================================================
角色或敌人的伤害显示位置，可在其备注框中添加以下注释：
 *
 *   Damage Offset: X:Y 
 *
 * 示例
 *
Damage Offset: 60:20
在敌人备注框中添加 Damage Offset: 60:20，
表示该敌人的伤害显示位置向右偏移 60 像素、向下偏移 20 像素
 */
